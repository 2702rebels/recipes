...
The team has standardized on the CTRE ecosystem, using [Phoenix 6](https://v6.docs.ctr-electronics.com/en/stable/) with Pro-licensed devices. The recommended default is torque-current (FOC) control. See [CTRE Control Modes](/docs/controls/ctre) for a full guide.
