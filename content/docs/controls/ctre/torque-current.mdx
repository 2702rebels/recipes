...
**About the name.** This section and [§4](/docs/controls/ctre/selection) say "FOC" to mean torque-current control, as most teams do. Strictly, FOC is a way of commutating the motor, and Phoenix Pro also uses it for voltage and duty-cycle requests when `EnableFOC = true` (see [§1.6](/docs/controls/ctre/motor-constants#16-motor-constants-reference)). What sets this section apart is the *output family*: Amps instead of Volts.
